...
- [anydesk](#anydesk)
    - [1. Technical overview](#1-technical-overview)
      - [1.1 Tactics & Techniques (MITRE ATT&CK)](#11-tactics--techniques-mitre-attck)
    - [2. Summary table of artifacts](#2-summary-table-of-artifacts)
      - [2.1 Non-volatile artifacts](#21-non-volatile-artifacts)
      - [2.2 Volatile artifacts](#22-volatile-artifacts)
    ...
    - [4. Volatile artifacts](#4-volatile-artifacts)
      ...
      - [4.3 Differentiation between WMI authentication and WMI execution](#43-differentiation-between-wmi-authentication-and-wmi-execution)
    - [5. Detection rules and collection targets](#5-detection-rules-and-collection-targets)
      - [5.1 Windows detection - Authentication](#51-windows-detection---authentication)
      - [5.2 Windows detection - Execution](#52-windows-detection---execution)
      - [5.3 SIGMA rules](#53-sigma-rules)
    ...
    ### 1.1 Tactics & Techniques (MITRE ATT&CK)
    ...
    ### 4.3 Differentiation between WMI authentication and WMI execution
    ...
    In contrast, **effective WMI execution** through query execution, method invocation, for example `Win32_Process.Create`, or event-based persistence, triggers full WMI telemetry. This includes:
    ...
    ### 5.1 Windows detection - Authentication
    ...
    **Expected behavior:**
    ...
    ### 5.2 Windows detection - Execution
...
- Sigma rule - HackTool NetExec Execution: <https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/proc_creation_win_hktl_netexec.yml>
