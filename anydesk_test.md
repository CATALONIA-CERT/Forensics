...
<summary>Operative System</summary>
...
The file <mark style="background-color:$info;">**`ad.trace`**</mark> serves as the <mark style="background-color:yellow;">**user interface log**</mark> for AnyDesk. It records critical session details, including the IP address of the remote participant, their AnyDesk ID, and events related to file transfers.

> <mark style="background-color:$info;">**What to look for?**</mark>
...
`C:\Windows\System32\winevt\Logs\`**`Microsoft-Windows-DeviceSetupManager`**`\Admin.evtx`, Event ID **112 (**&#x55;SB Connectio&#x6E;**)** -> `AnyDesk Printer`
